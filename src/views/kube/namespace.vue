<template>
  <div class="app-container">
    <el-button type="primary" @click="handleAddRole">New</el-button>
...
import { getNamespaces, createNamespace, deleteNamespace } from '@/api/kube'
  ...
  methods: {
    ...
    async confirmRole() {
      ...
      if (isEdit) {
        ...
        await createNamespace(this.role)
